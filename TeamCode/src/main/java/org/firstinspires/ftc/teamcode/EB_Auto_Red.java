...
/*
 * This OpMode is the Autonomous Mode program, when the robot starts in Red 01 position
 * as described by our Engineering notebook
 */

@Autonomous(name = "EB Auto Red", group = "Autonomous")
@Disabled
public class EB_Auto_Red extends LinearOpMode {
...
//    private final EB_EmptyHw robot               = new EB_EmptyHw();
    ...
    public void runOpMode() {
        ...
        EB_Hardware.AutoScenario thisScenario = EB_Hardware.AutoScenario.RED_01;
...
//        robot.sensorRGB.enableLed(true);
        ...
        while (opModeIsActive()) {
            ...
            // 5. Drop the Glyph
            robot.servoClawLeftBottom.setPosition(robot.CLAW_OPENED);
            robot.servoClawRightBottom.setPosition(robot.CLAW_OPENED);
...
//        showInfo("Status:  ", "liftGlyph() - Done");
    ...
    // we are RED so we'll have to push the BLUE jewel
    ...
    private void pushJewel(int direction){
        ...
        // read the current position of the wheels update
    }
    ...
    private RelicRecoveryVuMark decodeTargets () {
        ...
        while (vuMark == RelicRecoveryVuMark.UNKNOWN) {
            ...
            if (loopCount >= 100) {
                // waited 10 seconds. Let's move on. Whatever the vuMark value is just exit the loop
                break;
            }
        }
